...
class EmailTemplateController extends Controller
{
    ...
    public function index(){
        if (!Core::isAdmin()) {Session::flash('warning','Permission Denied');return redirect()->back();}
    ...
    public function mailbox_delete(Request $request){
        if(!empty($request->chackMail)){
            ...
            Core::activities("Delete", "Email log", "Delete mail log");
    ...
    public function store(Request $request, EmailTemplate $emailtemplate){
        ...
        $emailtemplate->create($request->merge([
            'name'          => $request->name,
            'slug'          => Core::getUniqueSlug($emailtemplate,$request->slug),
        ...
        Core::activities("Added", "Email Template", "Added a New Email template");
    ...
    public function update(Request $request, EmailTemplate $emailtemplate){
        ...
        Core::activities("Update", "Email Template", "update a Email template");
        return redirect('emailtemplate');
    }
    ...
    public function destroy(EmailTemplate $emailtemplate){
        ...
        Core::activities("Delete", "Email Template", "deleted a Email template");
        return redirect('emailtemplate');
    }
