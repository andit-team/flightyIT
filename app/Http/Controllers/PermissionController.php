...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($parents->all());
        return view('admin.users.permission.index', compact('data','parents'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.users.permission.create')->with('parent_ids',$parent_id);
    ...
    public function store(Request $request)
    {
        ...
        $permission->slug = Core::getUniqueSlug($permission, $request->name);
        $permission->save();
        $role = EloquentRole::find(1);
        $role->updatePermission($permission->slug, true, true)->save();
        Core::activities("Save", "Permission", "Added a new permission");
    ...
    public function edit($id)
    {
        ...
        $parents = Permission::where('parent_id',0)->get();
        return view('admin.users.permission.edit',compact('permission','parents'));
    }
