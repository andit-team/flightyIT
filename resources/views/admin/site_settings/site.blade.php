@extends('admin.layout.app',['pageTitle' => __('Site Settings')])
@section('content')
                    ...
                    <div class="form-group row {{ $errors->has('language') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <select name="language" id="" class="form-control">
                                @php echo Core::getOptionArray(['bn' => 'Bangla','en'=>'English','hi' => 'Hindi'],$siteSetting->language); @endphp
                            </select>
                    ...
                    <div class="form-group row {{ $errors->has('timezone') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <select name="timezone" id="" class="form-control">
                                @php echo Core::getTimezones($siteSetting->timezone); @endphp
                            </select>
                    ...
                    <div class="form-group row {{ $errors->has('currency') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <select name="currency" id="" class="form-control">
                                @php echo Core::getCurrencies($siteSetting->currency); @endphp
                            </select>
                    ...
                    <div class="form-group row {{ $errors->has('cur_position') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-sm-10">
                            <select name="cur_position" id="cur_position" class="form-control">
                                @php echo Core::getOptionArray(['before' => 'Before Amount','after'=>'After Amount'],$siteSetting->cur_position); @endphp
                            </select>
