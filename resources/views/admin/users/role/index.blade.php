                    ...
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$role->name}}</td>
                                <td>{{$role->slug}}</td>
                                <td><?php echo Core::globalDateTime($role->created_at)?></td>
                                <td style="display: flex; justify-content: space-evenly;">
                                    ...
                                    <a class="btn waves-effect waves-light text-light btn-xs btn-warning" href="{{url('system-admin/users/role/'.$role->id.'/edit')}}"><i class="fa fa-edit"></i></a>
                                    @if(Core::countUserinRole($role->id) == 0 )
                                    <form action="{{url('system-admin/users/role/'.$role->id.'/delete')}}" method="post"  style="margin-top:-2px" id="deleteButton{{$role->id}}">
                                        @csrf
