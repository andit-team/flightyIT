@extends('admin.layout.app',['pageTitle' => __('My Profile')])
@section('content')
    ...
    <div class="col-lg-12 col-md-12">
        <div class="card">
            <div class="card-body">
                ...
                <hr class="hr-borderd">
                <form class="form-horizontal form form-material m-t-40" method="post" action="{{route('myprofileupdate')}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-sm-10 d-flex">
                            ...
                            <div class="avatar-upload mr-3">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview" style="background-image: url({{!empty($user->profile_image)?asset($user->profile_image) : url('default.png')}});"></div>
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="avatar-upload">
                                ...
                                <div class="avatar-preview">
                                    <div id="login_image_Preview" style="background-image: url({{!empty($user->profile_banar)?asset($user->profile_banar) : url('default.png')}});"></div>
                                </div>
                            </div>
