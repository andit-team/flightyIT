@extends('admin.layout.app',['pageTitle' => __('Permission Management')])
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $key->slug}}</td>
                                            <td style="display: flex; justify-content: space-evenly;">
                                                ...
                                                <a class="btn waves-effect waves-light text-light btn-xs btn-warning" href="{{url('system-admin/users/permission/'.$key->id.'/edit')}}"><i class="fa fa-edit"></i></a>
                                            </td>
                                    </tr>
                                @endforeach
                                </tbody>
