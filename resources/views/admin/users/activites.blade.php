                        ...
                        <table class="table table-bordered table-hover Content" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if(Core::isAdmin())
                                    <td>
                                        <form action="{{url('system-admin/users/activities/'.$key->id.'/delete')}}" id="deleteButton{{$key->id}}" method="GET">
                                            <button class="btn btn-danger" name="archive" type="submit" onclick="sweetalertDelete({{$key->id}})"><i class="fa fa-trash"></i></button>
                                        </form>
                                        {{-- <a class="btn waves-effect waves-light text-light btn-xs btn-danger delete"  data-id="{{url('system-admin/users/activites/'.$key->id.'/delete')}}"
