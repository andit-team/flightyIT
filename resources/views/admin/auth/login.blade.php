              ...
              <form class="form-horizontal login-form" id="loginform" action="{{route('process_login')}}" method="post">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                        ...
                        {{-- <span class="btn btn-info" id="manager">Manager</span>
                        <span class="btn btn-primary" id="seller">Seller</span> --}}
                        {{-- <span class="btn btn-primary btn-info" id="diagno">User</span>
                        <span class="btn btn-primary" id="Core">Editor</span> --}}
                        {{-- <div class="social">
